function [Level, Player, Forces, Percentages, Deformation] = Function10(coords_player, elems_player)

%level-dependent values
level = 10;
Available_material = 30;
txt = "In this level, the beams have a thinner profile! To compensate, the mass of the weight has been reduced. " + newline + ...
    "Keep in mind that the compressed members will now break more easily due to the thin profile, as a result of the width of the cross-section being raised to the fourth power in the formula. " + newline + ...
    "To prevent your compressed members from buckling, make sure they are not too long!";
...
level_height = 4;
level_width = 4;
area = [0 level_width+0.1;0 level_height+0.1];
...
text(coords(3,1),coords(3,2)+0.75,sprintf('M = %d kg', Mass),'BackgroundColor', 'w', ...
        'HorizontalAlignment', 'center','Color',[0.467 0.675 0.188],'FontSize',14);
legend = text([2.5 2.5],[0.5+0.04*level_height 0.5-0.04*level_height],{'blue = tension' 'red = compression'},...
