function [Level, Player, Forces, Percentages, Deformation] = Function2(coords_player, elems_player)

%level-dependent values
level = 2;
Available_material = 1.5;
txt = "You can't build any elements that cross the red area! This is the area out structure is meant to overcome by being sufficiently strong.";
