function [Level, Player, Forces, Percentages, Deformation] = Function3(coords_player, elems_player)

%level-dependent values
level = 3;
Available_material = 2.5;
txt = "Would you look at that, the structure in this level is beginning to look more like an actual crane! " + newline + ...
    "As you can see, a large part of the structure has already been made for you! You just need to apply the finishing touches."; 
