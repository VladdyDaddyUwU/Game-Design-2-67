function [Level, Player, Forces, Percentages, Deformation] = Function4(coords_player, elems_player)

%level-dependent values
level = 4;
Available_material = 10;
txt = "As you are building your structure, you can click RUN to see what happens. If it fails, you can always retry!" + newline + ...
    "*arrow to % button* You can click the % button to see how close your members are to failing. If a member crosses 100%, it will either yield under its tensile stress, or buckle under compression."; 
