function [Level, Player, Forces, Percentages, Deformation] = Function5(coords_player, elems_player)

%level-dependent values
level = 5;
Available_material = 12;
txt = "Looks like the weight at the load-bearing node got a little heavier. But don't worry, with a strong structure you will be able to hold this weight up no problemo."; 
