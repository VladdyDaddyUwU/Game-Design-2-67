function [Level, Player, Forces, Percentages, Deformation] = Function9(coords_player, elems_player)

%level-dependent values
level = 9;
Available_material = 25;
txt = "These are getting pretty complicated now. Keep in mind what you have learned so far!"; 
