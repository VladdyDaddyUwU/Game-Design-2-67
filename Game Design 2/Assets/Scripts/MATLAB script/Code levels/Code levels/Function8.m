function [scale, Level, Player, Forces, Percentages, Deformation] = Function8(coords_player, elems_player)

%level-dependent values
level = 8;
Available_material = 15;
txt = "This level is a bit tricky. As always, pay close attention to which beam is failing if your construction breaks." + newline + ...
    "I'll give you a hint: beams can cross other beams without any problems! "; 
